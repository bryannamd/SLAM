...
| --- | --- | --- | --- | --- |
| bookmarks | 저장한 북마크를 보고 추가·삭제하며 태그로 찾는다 | p0 | verified | `app/src/BookmarksScreen.tsx`<br>`app/src/analytics.ts` |
| tags | 저장된 태그 목록을 보고 이름을 바꾸거나 삭제해 정리한다 | p1 | verified | `app/src/TagsScreen.tsx`<br>`app/src/analytics.ts` |
...
| --- | --- | --- |
| `bookmark_added` | 북마크 저장 | `bookmarks_per_active_user` |
| `bookmark_deleted` | 북마크 삭제 | — |
| `tag_filter_applied` | 태그 필터 칩 선택 | `tag_filter_usage_rate` |
